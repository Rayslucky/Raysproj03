...
public class UserModelTest {
	...
	public static void addTest() throws Exception {
		...
		dto.setDob(sdf.parse("04-04-1994"));
		dto.setConfirmPassword("Asdf@1234");
		dto.setPassword("Asdf@1234");
		dto.setLogin("luckymech786@gmail.com");
		dto.setGender("male");
		dto.setUnSuccessfullLogin(1);
		...
		dto.setRoleId(1);
		dto.setMobileNo("7999983647");
		dto.setRegisteredIP("luckymech786@gmail.com");
		dto.setLoginIP("luckymech786@gmail.com");
